...
<body id="page-top">
    ...
    <section id="main">
        ...
        <form id="patientForm" action="insertion.php" method="POST">
            <input type="hidden" name="form_origin" value="formulaires_patients.php?modal=true">
            ...
            <div class="page" id="page2">
                ...
                <section class="forms">
                    ...
                    <div>
                        ...
                        <input class="input" type="text" name="Nom_épouse" minlength="2" pattern="[A-Za-zÀ-ÖØ-öø-ÿ\s'-]+">
                    </div>
                    <div>
            ...
            <div class="page" id="page3">
                ...
                <div>
                    ...
                    <section class="forms">
                        <div>
                            ...
                            <input class="input" type="text" name="Nom_contact" pattern="[A-Za-zÀ-ÖØ-öø-ÿ\s'-]+" required>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input class="input" type="email" name="adresse_contact"
                                required>
                        </div>
                    </section>
                </div>
                <div>
                    ...
                    <section class="forms">
                        <div>
                            <label for="nom">Nom</label><br>
                            <input class="input" type="text" name="Nom_confiance" pattern="[A-Za-zÀ-ÖØ-öø-ÿ\s'-]+" required>
                        </div>
                        <div>
                            <label for="prénom">Prénom</label><br>
