        ...
        <nav>
            ...
            <ul class="menu">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        <li><a href="formulaires_patients.php" data-target="add-patient">Inscrire un patient</a></li>
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="../admin/admin_couvert.php" data-target="list-hospital">Liste des
                                couverture_scl</a></li>
                    </ul>
                </li>
                <li class="has-submenu">
        ...
        <form action="" method="POST">
            ...
            <section class="forms">
                ...
                <div>
                    ...
                    <input class="input" type="text" name="Nom" minlength="2" maxlength="25" id="nom" pattern="[A-Z\s]+"
                        required>
                </div>
                ...
                <div>
                    ...
                    <input placeholder="Mdp" class="input" name="Mdp" type="text" id="mdp" readonly />
                </div>
                <div>
