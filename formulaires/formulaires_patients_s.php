...
<body id="page-top">
        ...
        <nav>
            ...
            <ul class="menu">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        <li><a href="#">Inscrire un service</a></li>
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        <li><a href="formulaires_patients_s.php" data-target="add-patient">Inscrire un patient</a></li>
                        <li><a href="#" data-target="list-patient">Liste des patients</a></li>
                    </ul>
                </li>
                <li class="has-submenu">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        <li><a href="#" data-target="add-personnel">Inscrire un
                                personnel</a>
                        </li>
                        <li><a href="#">Liste du personnel</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="#" data-target="list-hospital">Liste des hospitalisations</a>
                        </li>
                    </ul>
                </li>
                <li class="has-submenu">
    ...
    <section id="main">
        ...
        <form id="patientForm" action="insertion.php" method="POST">
            <input type="hidden" name="form_origin" value="formulaires_patients_s.php">
                ...
                <div>
                    ...
                    <section class="forms">
                        ...
                        <div>
                            ...
                            <input class="input" type="text" name="adresse_contact" minlength="15" maxlength="38"
                                required>
                        </div>
                    </section>
                </div>
