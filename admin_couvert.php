...
<body>
    ...
    <header>
        ...
        <form id="decoForm" action="../formulaires/deconnexion.php" method="post" style="display: none;"></form>
        ...
        <nav>
            ...
            <ul class="menu">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        <li><a href="../formulaires/formulaires_patients.php" data-target="add-patient">Inscrire un
                                patient</a></li>
