...
<body>
      ...
      <ul class="menu">
        ...
        <li class="has-submenu">
          ...
          <ul class="submenu">
            ...
            <li><a href="secretaire_couvert.php" data-target="list-hospital">Liste des couverture_scl</a></li>
          </ul>
        </li>
        <!-- <li class="has-submenu">
  ...
  <main>
    <form method="get" class="search" action="secretaire_hos.php" onsubmit="scrollToPage5()">
      ...
      try {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
          if (isset($_POST['supprimer']) && !empty($_POST['selection'])) {
            ...
            header("Location: secretaire_hos.php"); // Redirection pour éviter la double soumission
            exit();
            ...
            header("Location: secretaire_hos.php"); // Redirection après toutes les modifications
            exit();
          }
        }
        ...
        echo "<form method='post' action='secretaire_hos.php'>";
        echo "<table border='2'>";
        ...
        if (!empty($resultats1)) {
          ...
          foreach ($resultats1 as $ligne) {
            ...
            foreach ($ligne as $colonne => $valeur) {
              // Vérifier si la colonne est l'adresse e-mail
              if ($colonne === 'Adresse_mail_utilisateur') {
                ...
                echo "<td><input type='text' name='modifications[" . htmlspecialchars($idhos, ENT_QUOTES, 'UTF-8') . "][" . htmlspecialchars($colonne, ENT_QUOTES, 'UTF-8') . "]' value='" . htmlspecialchars($valeur, ENT_QUOTES, 'UTF-8') . "'></td>";
              }
            }
  ...
  <footer></footer>
  <script src="../script_admin/scripts_admin.js"></script>
